...
public class WoodPackaging implements IPackageChain {
        ...
        public Order packaging(Order order) {
            if(order.getSize().equals(Size.Large.toString())
            || order.getSize().equals(Size.XLarge.toString())){
                order.setPackageType(PackagingMaterial.WOOD.toString());
